#ifndef __EXACT_POMDP_IMPORT_ML_H__
#define __EXACT_POMDP_IMPORT_ML_H__
...
#if !defined(PART_OF_EXACT_POMDP_IMPORT) && \
    !defined(STATIC_LINK_EXACT_POMDP_IMPORT) && \
    !defined(DYNAMIC_LINK_EXACT_POMDP_IMPORT)
#define PART_OF_EXACT_POMDP_IMPORT
#endif

#if defined(PART_OF_EXACT_POMDP_IMPORT)
#define MLLIB_PRIVATE(x) PRIVATE x
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(STATIC_LINK_EXACT_POMDP_IMPORT)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(DYNAMIC_LINK_EXACT_POMDP_IMPORT)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) EXTERNAL x
#else
#error Must specify linkage for exact_pomdp_import
#define MLLIB_PRIVATE(x)
...
#endif /* __EXACT_POMDP_IMPORT_ML_H__ */
